...
var file_calculator_proto_rawDesc = []byte{
	...
	0x72, 0x74, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x32, 0xb6, 0x02, 0x0a, 0x0b, 0x43, 0x61, 0x6c,
	0x63, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x36, 0x0a, 0x03, 0x41, 0x64, 0x64, 0x12,
	...
	0x12, 0x38, 0x0a, 0x03, 0x41, 0x76, 0x67, 0x12, 0x16, 0x2e, 0x63, 0x61, 0x6c, 0x63, 0x75, 0x6c,
	...
	0x73, 0x68, 0x75, 0x63, 0x68, 0x74, 0x6f, 0x6e, 0x2f, 0x67, 0x72, 0x70, 0x63, 0x2d, 0x67, 0x6f,
...
var file_calculator_proto_depIdxs = []int32{
	0, // 0: calculator.CalcService.Add:input_type -> calculator.SumRequest
	1, // 1: calculator.CalcService.Prime:input_type -> calculator.PrimeRequest
	2, // 2: calculator.CalcService.Avg:input_type -> calculator.AvgRequest
	3, // 3: calculator.CalcService.Max:input_type -> calculator.MaxRequest
	4, // 4: calculator.CalcService.Sqrt:input_type -> calculator.SqrtRequest
	5, // 5: calculator.CalcService.Add:output_type -> calculator.SumResponse
	6, // 6: calculator.CalcService.Prime:output_type -> calculator.PrimeResponse
	7, // 7: calculator.CalcService.Avg:output_type -> calculator.AvgResponse
	8, // 8: calculator.CalcService.Max:output_type -> calculator.MaxResponse
	9, // 9: calculator.CalcService.Sqrt:output_type -> calculator.SqrtResponse
